...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    if (url.pathname.includes("index")) {
        ...
        if (!user_session) {
            ...
            const usuario = await obtenerDatosAPI(
            ...
            function habilitarEdicion(
                ...
                elementoEditable.addEventListener("blur", async (e) => {
                    const elemento_editado = e.target;
                    usuario.process_items[
                        elemento_editado.closest("form").getAttribute("i")
                    ][p.getAttribute("seccion")] = elemento_editado.value;
                    ...
                    if (
                        ...
                        elementoEditable.type === "select-one"
                    ) {
            ...
            async function cargarProcesos() {
                ...
                procesos_de_usuario.forEach((proceso) => {
                    ...
                    p_titulo.setAttribute("seccion", "titulo");
                    ...
                    p_genero.setAttribute("seccion", "genero");
                    ...
                    p_plataforma.setAttribute("seccion", "plataforma");
                    ...
                    p_estado.setAttribute("seccion", "estado");
                    ...
                    p_formato.setAttribute("seccion", "formato");
                    ...
                    p_fecha.setAttribute("seccion", "fecha");
                    p_fecha.textContent = proceso.fecha || "Pendiente";
                    ...
                    p_valoracion.setAttribute("seccion", "valoracion");
                    ...
                    q_resena.setAttribute("seccion", "resena");
                    q_resena.textContent = proceso.reseña || "Pendiente"; // Contenido de la reseña
                    ...
                    boton_eliminar.addEventListener("click", async (e) => {
                        e.preventDefault();
                        usuario.process_items.splice(
                            Number(proceso_cuerpo.getAttribute("i")),
                            1
                        );
                        await actualizarDatosAPI(
                            MOCKAPI_BASEURL +
            ...
            const procesos_en_pantalla = document.querySelector("article");
            // Iniciar la observación del elemento
            observador.observe(procesos_en_pantalla, { childList: true });
        }
    }
});
